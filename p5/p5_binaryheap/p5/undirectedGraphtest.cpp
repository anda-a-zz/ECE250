            ...
            if (input.find("i") == 0 && input.find(' ') == 1 && input.substr(1,2) != " ") {
                ...
                for (int i = 0; i < 3; i++) {
                    ...
                    if (i < 2)
                        ...
                        distance = stod(input.substr(0, input.length()));
                    }
                ...
                cout << "degree of " << input << " " << degree_val << endl;
                ...
                distance = G.W(city[0], city[1]);
                
                if (distance != -1)
                    cout << "direct distance " << city[0] << " to " << city[1] << " " << distance << endl;
                else
                    cout << "failure" << endl;
                ...
                distance = G.dijkstra_alg(city[0], city[1], false);
                cout << "shortest distance " << city[0] << " to " << city[1] << " " << distance << endl;
                //cout << city[0] << " " << city[1] << endl;
                ...
                G.dijkstra_alg(city[0], city[1], true);
                //cout << city[0] << " " << city[1] << endl;
